...
export const outdatedAspireCliWarning = (version: string, minimumVersion: string) => vscode.l10n.t('Aspire CLI {0} is older than {1}. Update it to avoid a known AppHost startup failure in VS Code.', version, minimumVersion);
