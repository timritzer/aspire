...
export const outdatedAspireCliWarning = (version: string, minimumVersion: string) => vscode.l10n.t("Aspire CLI {0} is older than {1}. Update the CLI and the AppHost's Aspire packages to {1} or later to avoid a known startup failure in VS Code.", version, minimumVersion);
