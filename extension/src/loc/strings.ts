...
export const addIntegrationTestProjectRequiresCSharpAppHost = vscode.l10n.t('Integration test project scaffolding requires a project-based C# AppHost.');
...
export const addIntegrationTestProjectCapabilityCouldNotBeVerified = vscode.l10n.t('Integration test project scaffolding support could not be verified for the selected Aspire CLI. Verify the Aspire CLI installation and try again.');
